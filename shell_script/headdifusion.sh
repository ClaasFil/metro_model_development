...
gfortran -c -I$BIN_DIR src/fortran/past_weeks/heatdiffusion2d.f90 -o $BIN_DIR/heatdiffusion2d.o
...
gfortran $BIN_DIR/utilities.o $BIN_DIR/finitdifferences.o $BIN_DIR/heatdiffusion2d.o -o $BIN_DIR/heatdiffusion2d
